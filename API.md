...
4. Even if a table name must be singular in the `include[]=other` clause, the actual (plural) table names must be used in the "\<other table name>.\<column name>=value" filtering clause.
