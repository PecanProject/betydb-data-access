...
* As a special case, to query the traits\_and\_yields\_view, use "search" in place of the table name.  For example, `https://www.betydb.org/search.json` returns the rows of this view in JSON format.
